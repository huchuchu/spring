# spring basic
##### [출처 : 스프링 입문 - 코드로 배우는 스프링 부트, 웹 MVC, DB 접근 기술 강의](https://www.inflearn.com/course/%EC%8A%A4%ED%94%84%EB%A7%81-%EC%9E%85%EB%AC%B8-%EC%8A%A4%ED%94%84%EB%A7%81%EB%B6%80%ED%8A%B8/dashboard) {:target="_blank"}
##### <a href="https://www.inflearn.com/course/%EC%8A%A4%ED%94%84%EB%A7%81-%EC%9E%85%EB%AC%B8-%EC%8A%A4%ED%94%84%EB%A7%81%EB%B6%80%ED%8A%B8/dashboard" target="_blank">
출처 : 스프링 입문 - 코드로 배우는 스프링 부트, 웹 MVC, DB 접근 기술 강의
</a>
 ...
 * 정적 컨텐츠 : 서버에서 뭐 하는 것 없이 파일을 그냥 웹브라우저에 내려주는 것
  ...
  * DI 종류 : __생성자 주입__, 필드주입, setter주입. 의존관계가 실행중에 동적으로 변하는 경우는 거의 없으므로 생성자 주입을 권장한다
  ...
  *
   ...
   * JPA를 사용하면 SQL과 데이터 중심의 설계에서 객체 중심ㄴ의 설계로 패러다임을 전환할 수 있다.
   * JPA를 사용하면 개발 생산성을 크게 높일 수 있다.
   * JPA는 인터페이스이고 구현체로 hibernate등 여러 기술들이 있다.
   * JPA : DB테이블과 자바 객체 사이의 맵핑을 처리해주는 기술
   
   ### 스프링 데이터 JPA
   * 스프링 데이터 JPA는 JPA를 편리하게 사용하도록 도와주는 기술이기때문에 JPA를 먼저 학습후에 스프링 데이터 JPA를 학습해야한다.
   * 스프링 JPA 제공기능
    - 인터페이스를 통한 기본적인 CRUD
